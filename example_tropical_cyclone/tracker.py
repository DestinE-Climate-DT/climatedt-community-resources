...
def detectnodes(datelist:list,nodes_path:str,ncfile_prefix:str)->str:
    ...
    for date in datelist:
        ...
        in_file = f"{ncfile_prefix}_{date}.nc"
        out_file = f"{nodes_path}/nodes_{date}.txt"
    ...
    all_nodes = f'{nodes_path}/all_nodes.dat'
